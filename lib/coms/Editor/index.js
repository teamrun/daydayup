...
var Editor = React.createClass({
    ...
    updateRangeState(range){
        ...
        let cursorStyle = getCursorStyle(rects, ctnScrollOffset, DEFAULT_LINEHEIGHT, range.endContainer, range.endOffset);
        let selectionStyles = getSelectionStyles(rects, ctnScrollOffset, DEFAULT_LINEHEIGHT, range.endContainer, range.endOffset);
        // console.log(rects);
